...
const program = 'MSA';
const rows = [
  ['North Carolina', 27, 36, 33, 96, '33.9%', 'Lead location signal; prioritize alumni, employer history, and role searches here.'],
  ['New York', 19, 14, 12, 45, '15.9%', 'High-value external market; pair applications with alumni outreach and market-specific search terms.'],
  ['Georgia', 5, 7, 10, 22, '7.8%', 'Strong regional market; useful for Southeast, Mid-Atlantic, and campus-connected searches.'],
  ['Massachusetts', 6, 7, 5, 18, '6.4%', 'High-value external market; pair applications with alumni outreach and market-specific search terms.'],
  ['California', 3, 7, 4, 14, '4.9%', 'High-value external market; pair applications with alumni outreach and market-specific search terms.'],
  ['Florida', 5, 5, 2, 12, '4.2%', 'Strong regional market; useful for Southeast, Mid-Atlantic, and campus-connected searches.'],
  ['Texas', 3, 7, 2, 12, '4.2%', 'High-value external market; pair applications with alumni outreach and market-specific search terms.'],
  ['Illinois', 5, 3, 3, 11, '3.9%', 'High-value external market; pair applications with alumni outreach and market-specific search terms.'],
  ['Washington, DC', 4, 2, 4, 10, '3.5%', 'Strong regional market; useful for Southeast, Mid-Atlantic, and campus-connected searches.'],
  ['Virginia', 2, 4, 2, 8, '2.8%', 'Strong regional market; useful for Southeast, Mid-Atlantic, and campus-connected searches.']
];
const totals = { y2023: 89, y2024: 103, y2025: 91, total: 283 };
